...
function test__aws_keymap_w__with_account_id {
	assert "$(
		local orig=$AWS_ACCOUNTS_TSV
		AWS_ACCOUNTS_TSV=/tmp/test__aws_keymap_w.tsv
		printf 'acme-prod\t111111111111\nacme-staging\t222222222222\n' > "$AWS_ACCOUNTS_TSV"

		aws_keymap_w 111111111111
...
function test__aws_keymap_w__with_account_name {
	assert "$(
		local orig=$AWS_ACCOUNTS_TSV
		AWS_ACCOUNTS_TSV=/tmp/test__aws_keymap_w.tsv
		printf 'acme-prod\t111111111111\nacme-staging\t222222222222\n' > "$AWS_ACCOUNTS_TSV"

		aws_keymap_w staging
...
function test__aws_keymap_w__with_instance_id {
	assert "$(aws_keymap_w 0abc123def456ghi7)" 'i-0abc123def456ghi7'
}

function test__aws_keymap_w__with_prefixed_instance_id {
	assert "$(aws_keymap_w i-0abc123def456ghi7)" 'i-0abc123def456ghi7'
}

function test__aws_keymap_w__with_pasteboard {
	assert "$(
		local orig=$AWS_ACCOUNTS_TSV
		AWS_ACCOUNTS_TSV=/tmp/test__aws_keymap_w.tsv
		printf 'acme-prod\t111111111111\nacme-staging\t222222222222\n' > "$AWS_ACCOUNTS_TSV"

		echo 111111111111 | pbcopy
		aws_keymap_w
