...
VIMIUM_SEARCH_KEYMAP_FILE="$ZSHRC_DIR/${VIMIUM_NAMESPACE}s/$VIMIUM_SEARCH_NAMESPACE.extracted.zsh"

source "$ZSHRC_DIR/${VIMIUM_NAMESPACE}s/vimium_search_helpers.zsh"
