...
GIT_KEYMAP=(
	...
	''
	"${GIT_DOT}y <sha>? # Cherry pick a commit (Default: Pasteboard)"
	"${GIT_DOT}yc # Cherry pick continue"
	"${GIT_DOT}ya # Cherry pick abort"
	''
	"${GIT_DOT}v <sha>? # Revert a commit (Default: Pasteboard)"
	"${GIT_DOT}vc # Revert continue"
	"${GIT_DOT}va # Revert abort"
	''
	"${GIT_DOT}u <number>? # Undo the last N commits (Default: 1)"
