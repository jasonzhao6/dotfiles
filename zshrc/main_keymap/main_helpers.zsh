...
function main_helpers_show_default_keyboard_shortcuts {
	local name=$1; shift
	local description=$*
...
function main_helpers_print_key_mappings {
...
function main_helpers_extract_keymaps {
	local keymap_name=$1

	main_helpers_find_keys

	# Open keymap array
	local extracted="# This file is generated by \`main_helpers_extract_keymaps\`\n$keymap_name=(\n"
...
function main_helpers_find_key_mappings {
	local description=$*
	reply_zsh_mappings=()
