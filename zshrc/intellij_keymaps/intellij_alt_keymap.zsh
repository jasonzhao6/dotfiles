...
INTELLIJ_ALT_KEYMAP=(
	...
	''
	"alt-{tab} # Next line bookmark (TextMate: \`{F2}\`)"
	"alt-shift-{tab} # Previous line bookmark (TextMate: \`shift-{F2}\`)"
	"cmd-alt-{tab} # Toggle bookmark (TextMate: \`cmd-{F2}\`)"
	"cmd-alt-shift-{tab} # Show bookmarks (\`cmd-shift-{F2}\`)"
