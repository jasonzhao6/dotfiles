...
# ZSHRC_UNDER_PROFILING=1

# Profile `.zshrc` load time: Start here
...
source "$ZSHRC_SRC_DIR/utils.zsh"

# Load keymap helpers
source "$ZSHRC_SRC_DIR/_keymap/keymap_base.zsh"
source "$ZSHRC_SRC_DIR/_keymap/is_reserved.zsh"
...
source "$ZSHRC_SRC_DIR/kiro_keymap/kiro_keymap.zsh"
source "$ZSHRC_SRC_DIR/kubectl_keymap/kubectl_keymap.zsh"
source "$ZSHRC_SRC_DIR/main_keymap/main_keymap.zsh"
source "$ZSHRC_SRC_DIR/nav_keymap/nav_keymap.zsh"
...
source "$ZSHRC_SRC_DIR/intellij_keymaps/intellij_alt_keymap.zsh"
source "$ZSHRC_SRC_DIR/intellij_keymaps/intellij_cmd_keymap.zsh"
source "$ZSHRC_SRC_DIR/intellij_keymaps/intellij_ctrl_keymap.zsh"
source "$ZSHRC_SRC_DIR/intellij_keymaps/intellij_all_keymap.zsh" # Depends on the above 3
source "$ZSHRC_SRC_DIR/vimium_keymaps/vimium_keymap.zsh"
source "$ZSHRC_SRC_DIR/vimium_keymaps/vimium_search_keymap.zsh"

# Load zsh configs
source "$ZSHRC_SRC_DIR/zsh_arrow_keys.zsh"
source "$ZSHRC_SRC_DIR/zsh_history.zsh"
source "$ZSHRC_SRC_DIR/zsh_prompt.zsh"

# Source secrets
[[ -z $ZSHRC_UNDER_TESTING && -f $ZSHRC_SECRETS ]] && source "$ZSHRC_SECRETS"

# Track `.zshrc` load time: Finish here
if [[ -z $ZSHRC_UNDER_TESTING ]]; then
	gray_fg "\n\`.zshrc\` loaded in $(echo "$(gdate +%s.%2N) - $ZSHRC_START_TIME" | bc) seconds"
fi

# Profile `.zshrc` load time: Finish here
