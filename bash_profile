...
alias bpp='source ~/.bash_profile && cp ~/.bash_profile ~/Documents/dotfiles/bash_profile && cp ~/.bash_profile ~/Library/Mobile\ Documents/com~apple~CloudDocs/Try/al/bash_profile && cp ~/.work_profile ~/Library/Mobile\ Documents/com~apple~CloudDocs/Try/al/work_profile'
alias bpw='mate ~/.work_profile'
alias da='direnv allow && cp .envrc ~/Library/Mobile\ Documents/com~apple~CloudDocs/Try/al/envrc/${PWD##*/}'
alias dm='mate .envrc'
alias dmm='mate ~/Library/Mobile\ Documents/com~apple~CloudDocs/Try/al/envrc/'
...
alias cdq='cd ~/Documents/quad-core-parkour/vanilla'
...
# Rails
alias rc='DISABLE_SPRING=true EDITOR=mate rails c' # EDITOR for `edit`
alias rs='DISABLE_SPRING=true EDITOR=mate rails s --binding 0.0.0.0'
alias ss='rspec'
...
alias gg='git checkout main'
alias gi='git cherry-pick'
alias gm='git add --all .; git commit --amend'
alias gn='git checkout main; git pull; git checkout -b'
alias ll='git pull'
